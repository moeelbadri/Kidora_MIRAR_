...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    figure_id INTEGER DEFAULT NULL,
...
-- كل بيانات البذر تعيش في database/seed.php كمصدر واحد،
-- وتُستدعى تلقائياً عند إنشاء قاعدة SQLite لأول مرة.
-- ============================================================
